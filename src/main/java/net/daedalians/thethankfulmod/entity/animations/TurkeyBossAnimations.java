package net.daedalians.thethankfulmod.entity.animations;// Save this class in your mod and generate all required imports
...
public class TurkeyBossAnimations {
	public static final AnimationDefinition ATTACK = AnimationDefinition.Builder.withLength(1.0F)
		.addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			...
			new Keyframe(0.625F, KeyframeAnimations.degreeVec(100.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
