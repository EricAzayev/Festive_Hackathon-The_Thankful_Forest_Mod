package net.daedalians.thethankfulmod.worldgen.biome.surface;
...
public class ModSurfaceRules {
    ...
    //private static final SurfaceRules.RuleSource FALL_GRASS = makeStateRule(ModBlocks.FALL_GRASS.get());
    ...
    public static SurfaceRules.RuleSource makeRules() {
        ...
        return SurfaceRules.sequence(
                SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.isBiome(ModBiomes.FALL_BIOME),
