...
import net.daedalians.thethankfulmod.entity.client.TurkeyBossModel;
...
public class ModEventBusClientEvents {
    ...
    public static void registerLayer(EntityRenderersEvent.RegisterLayerDefinitions event){
        ...
        event.registerLayerDefinition(ModModelLayers.TURKEY_BOSS_LAYER, TurkeyBossModel::createBodyLayer);
    }
}
